...
## 2.1 BASELINE [ML](0%20-%20hot%20to%20use.md#essential-acronym-glossary) & LINEAR METHODS (TABULAR DATA)
...
* **Typical Loss Function:** [MSE](0%20-%20hot%20to%20use.md#essential-acronym-glossary) (Mean Squared Error) for Linear; Log-Loss (Binary Cross-Entropy) for Logistic.
...
### 2.1.2 K-NEAREST NEIGHBORS ([KNN](0%20-%20hot%20to%20use.md#essential-acronym-glossary))
...
* **Common Pitfalls & Quick Fixes:**
  ...
  * **Pitfall:** Accuracy collapses as the number of columns (features) increases.
    * *Quick Fix:* Curse of Dimensionality (in high-dimensional spaces, points tend to become equidistant). Apply `PCA` or feature selection before [KNN](0%20-%20hot%20to%20use.md#essential-acronym-glossary).
...
* **Typical Loss Function:** Gini Impurity or Entropy (Classification); [MSE](0%20-%20hot%20to%20use.md#essential-acronym-glossary) or [MAE](0%20-%20hot%20to%20use.md#essential-acronym-glossary) (Regression).
* **Common Pitfalls & Quick Fixes:**
...
### 2.1.4 SUPPORT VECTOR MACHINES ([SVM](0%20-%20hot%20to%20use.md#essential-acronym-glossary))
...
* **GO (Use when):** Medium-small datasets with high dimensionality (e.g. classic [NLP](0%20-%20hot%20to%20use.md#essential-acronym-glossary) based on [TF-IDF](0%20-%20hot%20to%20use.md#essential-acronym-glossary)). Need for robust and mathematically guaranteed decision boundaries.
