...
### 2.3.2 DIMENSIONALITY REDUCTION: [PCA](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali), t-SNE, UMAP
...
* **GO (Usare quando):** [PCA](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali): Rimozione della multicollinearità, riduzione del carico computazionale prima di altri modelli [ML](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali). t-SNE/UMAP: Esplorazione visiva 2D di dataset altamente complessi (es. embedding testuali o genomica).
...
**LIVELLO 2: OPERATIONS**
* **Principi di funzionamento:**
  * **[PCA](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) (Lineare):** Proiezione ortogonale che cerca gli assi (Componenti Principali) in cui la varianza dei dati è massima.
...
| ALGORITMO | PRO | CONTRO |
| :--- | :--- | :--- |
| **[PCA](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali)** | Veloce, deterministico, preserva struttura globale. Le componenti sono ortogonali. | Non cattura relazioni non lineari. Sensibile agli outlier. |
...
| **UMAP** | Più veloce di t-SNE, preserva meglio la topologia globale, può fare feature extraction utile per [ML](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali). | Richiede tuning meticoloso, la matematica sottostante è complessa (geometria differenziale). |

**LIVELLO 3: DEEP DIVE & TROUBLESHOOTING**
* **Iperparametri Chiave:**
  * **[PCA](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali):** `n_components` (Selezionare in base alla varianza spiegata cumulativa, es. 95%).
...
* **Common Pitfalls & Quick Fixes:**
  * **Pitfall:** La prima componente della [PCA](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) domina con il 99% della varianza, ma i dati non hanno senso.
    * *Quick Fix:* Non hai scalato i dati. La [PCA](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) cerca la massima varianza assoluta: una feature misurata in "Milioni" schiaccerà una feature misurata in "Percentuali". `StandardScaler` obbligatorio.
...
### 2.3.3 AUTOENCODERS (STANDARD & [VAE](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali))
...
* **GO (Usare quando):** Denoising di immagini/segnali. Anomaly Detection (errore di ricostruzione alto su dati mai visti). **Feature Extraction (Deep Clustering):** usare il Bottleneck come input per modelli classici (K-Means/[SVM](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali)) o per UMAP, permettendo al [ML](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) classico di digerire dati non strutturati.
* **NO-GO (Evitare quando):** Dataset tabulari semplici e piccoli ([PCA](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) è più rapida, interpretabile e meno prona all'overfitting).
...
* **Principi di funzionamento:**
  ...
  * **[VAE](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) (Variational Autoencoder):** Invece di mappare un input a un singolo punto latente, lo mappa a una distribuzione di probabilità (media e varianza). Forza lo spazio latente a essere continuo, permettendo di campionare nuovi punti inventati (Generazione).
...
| **[VAE](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali)** | Spazio latente continuo e strutturato. Permette generazione, interpolazione tra immagini/dati e sampling. | Ricostruzioni spesso sfocate rispetto a [GAN](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) o Diffusion Models. Addestramento complesso. |

**LIVELLO 3: DEEP DIVE & TROUBLESHOOTING**
* **Iperparametri Chiave:**
  * Architettura Rete (Dimensione Bottleneck, numero di layer).
  * **[VAE](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali):** Peso della Divergenza [KL](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) (Beta). Bilancia la fedeltà di ricostruzione (Reconstruction Loss) con la regolarizzazione dello spazio latente.
* **Funzione di Loss Tipica:** [MSE](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) o [BCE](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) per la ricostruzione (Standard AE). [MSE](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) + Divergenza [KL](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) ([VAE](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali)).
* **Common Pitfalls & Quick Fixes:**
  ...
  * **Pitfall ([VAE](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali)):** "Posterior Collapse" o [KL](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) Vanishing. L'encoder ignora i dati in ingresso e predice sempre una gaussiana standard. Il decoder collassa generando sempre la stessa media.
    * *Quick Fix:* La loss [KL](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) sta dominando troppo presto nel training. Applica "[KL](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) Annealing": imposta il peso della loss [KL](0%20-%20hot%20to%20use.md#glossario-acronimi-essenziali) a 0 all'inizio del training e alzalo linearmente verso 1 nel corso delle epoch, per permettere prima al decoder di imparare a ricostruire.